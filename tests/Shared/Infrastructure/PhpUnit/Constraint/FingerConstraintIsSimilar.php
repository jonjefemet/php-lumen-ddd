...
namespace Finger\Tests\Shared\Infrastructure\PhpUnit\Constraint;

use Finger\Tests\Shared\Infrastructure\PhpUnit\Comparator\AggregateRootArraySimilarComparator;
use Finger\Tests\Shared\Infrastructure\PhpUnit\Comparator\AggregateRootSimilarComparator;
use Finger\Tests\Shared\Infrastructure\PhpUnit\Comparator\DateTimeSimilarComparator;
use Finger\Tests\Shared\Infrastructure\PhpUnit\Comparator\DateTimeStringSimilarComparator;
use Finger\Tests\Shared\Infrastructure\PhpUnit\Comparator\DomainEventArraySimilarComparator;
use Finger\Tests\Shared\Infrastructure\PhpUnit\Comparator\DomainEventSimilarComparator;
...
final class FingerConstraintIsSimilar extends Constraint
{
    ...
    public function toString(): string
    {
        ...
        return sprintf('is equal to %s%s', var_export($this->value, true), $delta);
    }
}
